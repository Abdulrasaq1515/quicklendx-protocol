...
impl GasTestHarness {
    ...
    fn setup_verified_entities(&mut self) {
        ...
        let _ = client
            .try_submit_kyc_application(&self.business, &String::from_str(env, "Business KYC"));
        let _ = client.try_verify_business(&self.admin, &self.business);

        let _ =
            client.try_submit_investor_kyc(&self.investor, &String::from_str(env, "Investor KYC"));
    ...
    fn compare_or_update(&self, name: &str, scenario: &str, delta: BudgetDelta) {
        ...
        let mut baseline_file: BaselineFile =
            toml::from_str(&content).unwrap_or_else(|_| BaselineFile {
                metadata: Metadata {
        ...
        if !found {
            ...
            if update_mode {
                ...
                panic!(
                    "No baseline found for entrypoint '{}' scenario '{}'",
                    name, scenario
                );
            }
        }
...
macro_rules! bench_scenario {
    ($harness:expr, $entrypoint:expr, $scenario:expr, $expr:expr) => {
        let delta = quicklendx_contracts::bench::measure(&$harness.env, $entrypoint, || {
            let _ = $expr;
        });
...
fn test_admin_gas() {
    ...
    bench_scenario!(
        ...
        "get_protocol_limits",
        "default",
        client.try_get_protocol_limits()
    );
    bench_scenario!(
        harness,
        "extend_protocol_ttl",
        "default",
        client.try_extend_protocol_ttl(&harness.admin)
    );
    bench_scenario!(
        harness,
        "invariant_self_check",
        "default",
        client.try_invariant_self_check(&harness.admin)
    );
    bench_scenario!(
        harness,
        "initialize_admin",
        "default",
        client.try_initialize_admin(&harness.admin)
    );
    bench_scenario!(
        harness,
        "get_current_admin",
        "default",
        client.try_get_current_admin()
    );
    ...
    bench_scenario!(
        ...
        "transfer_admin",
        "default",
        client.try_transfer_admin(&harness.business)
    );
    bench_scenario!(
        harness,
        "set_admin",
        "default",
        client.try_set_admin(&harness.admin)
    );
...
fn test_kyc_gas() {
    ...
    bench_scenario!(
        ...
        "default",
        client.try_submit_kyc_application(&harness.business, &String::from_str(env, "KYC Data"))
    );
    bench_scenario!(
        harness,
        "submit_investor_kyc",
        "default",
        client.try_submit_investor_kyc(&harness.investor, &String::from_str(env, "KYC Data"))
    );
    bench_scenario!(
        harness,
        "verify_investor",
        "default",
        client.try_verify_investor(&harness.investor, &1_000_000)
    );
    bench_scenario!(
        harness,
        "get_verified_businesses",
        "default",
        client.try_get_verified_businesses()
    );
    bench_scenario!(
        harness,
        "reject_investor",
    ...
    bench_scenario!(
        ...
        "default",
        client.try_get_investor_verification(&harness.investor)
    );
    bench_scenario!(
        harness,
    ...
    bench_scenario!(
        ...
        "verify_business",
        "default",
        client.try_verify_business(&harness.admin, &harness.business)
    );
    bench_scenario!(
        harness,
        "reject_business",
    ...
    bench_scenario!(
        ...
        "default",
        client.try_get_business_verification_status(&harness.business)
    );
    bench_scenario!(
        harness,
        "get_pending_businesses",
        "default",
        client.try_get_pending_businesses()
    );
    bench_scenario!(
        harness,
        "get_rejected_businesses",
        "default",
        client.try_get_rejected_businesses()
    );
    bench_scenario!(
        harness,
        "get_verified_investors",
        "default",
        client.try_get_verified_investors()
    );
    bench_scenario!(
        harness,
        "get_pending_investors",
        "default",
        client.try_get_pending_investors()
    );
    bench_scenario!(
        harness,
        "get_rejected_investors",
        "default",
        client.try_get_rejected_investors()
    );
    bench_scenario!(
        harness,
    ...
    bench_scenario!(
        ...
        "default",
        client.try_get_investor_analytics(&harness.investor)
    );
    bench_scenario!(
        harness,
        "get_investors_by_tier",
        "default",
        client.try_get_investors_by_tier(&InvestorTier::Gold)
    );
    bench_scenario!(
        harness,
        "get_investors_by_risk_level",
        "default",
        client.try_get_investors_by_risk_level(&InvestorRiskLevel::Low)
    );
    bench_scenario!(
        harness,
    ...
    bench_scenario!(
        ...
        "default",
        client.try_validate_investor_investment(&harness.investor, &100_000)
    );
    bench_scenario!(
        harness,
        "is_investor_verified",
        "default",
        client.try_is_investor_verified(&harness.investor)
    );
}
...
fn test_invoice_gas() {
    ...
    bench_scenario!(
        ...
        client.try_upload_invoice(
            ...
            &harness.currency,
            &due_date,
            &String::from_str(env, "Invoice Description"),
            &InvoiceCategory::Services,
            &Vec::new(env)
        )
    );
    ...
    bench_scenario!(
        harness,
        "upload_invoice",
        "largest-realistic-invoice",
        client.try_upload_invoice(
            &harness.business,
            &100_000_000,
            &harness.currency,
            &due_date,
            &String::from_str(env, &"a".repeat(1000)),
    ...
    bench_scenario!(
        ...
        "verify_invoice",
        "default",
        client.try_verify_invoice(&harness.invoice_id)
    );
    bench_scenario!(
        harness,
        "expire_invoice",
        "default",
        client.try_expire_invoice(&harness.invoice_id)
    );
    bench_scenario!(
        harness,
        "cleanup_expired_bids_paged",
        "default",
        client.try_cleanup_expired_bids_paged(&harness.invoice_id, &0, &10)
    );
    bench_scenario!(
        harness,
    ...
    bench_scenario!(
        ...
        "get_invoices_by_tag",
        "default",
        client.try_get_invoices_by_tag(&String::from_str(env, "tag1"))
    );
    bench_scenario!(
        harness,
        "get_invoices_by_tags",
        "default",
        client.try_get_invoices_by_tags(&tags)
    );
    bench_scenario!(
        harness,
        "get_invoice_count_by_category",
        "default",
        client.try_get_invoice_count_by_category(&InvoiceCategory::Services)
    );
    bench_scenario!(
        harness,
        "get_invoice_count_by_tag",
        "default",
        client.try_get_invoice_count_by_tag(&String::from_str(env, "tag1"))
    );
    bench_scenario!(
        harness,
        "update_invoice_category",
        "default",
        client.try_update_invoice_category(&harness.invoice_id, &InvoiceCategory::Consulting)
    );
    bench_scenario!(
        harness,
        "add_invoice_tag",
        "default",
        client.try_add_invoice_tag(&harness.invoice_id, &String::from_str(env, "tag2"))
    );
    bench_scenario!(
        harness,
        "remove_invoice_tag",
        "default",
        client.try_remove_invoice_tag(&harness.invoice_id, &String::from_str(env, "tag2"))
    );
    bench_scenario!(
        harness,
        "get_invoice_tags",
        "default",
        client.try_get_invoice_tags(&harness.invoice_id)
    );
    bench_scenario!(
        harness,
        "invoice_has_tag",
        "default",
        client.try_invoice_has_tag(&harness.invoice_id, &String::from_str(env, "tag1"))
    );
    bench_scenario!(
        harness,
...
fn test_bid_gas() {
    ...
    bench_scenario!(
        ...
        "place_bid",
        "default",
        client.try_place_bid(&harness.investor, &harness.invoice_id, &100_000, &10_000)
    );
    bench_scenario!(
        harness,
        "cancel_bid",
        "default",
        client.try_cancel_bid(&harness.bid_id)
    );
    bench_scenario!(
        harness,
        "withdraw_bid",
        "default",
        client.try_withdraw_bid(&harness.bid_id)
    );
    bench_scenario!(
        harness,
        "get_all_bids_by_investor",
        "default",
        client.try_get_all_bids_by_investor(&harness.investor)
    );
    bench_scenario!(
        harness,
    ...
    bench_scenario!(
        ...
        "get_bid_history",
        "default",
        client.try_get_bid_history(&harness.invoice_id)
    );
    bench_scenario!(
        harness,
        "clean_expired_bids",
        "default",
        client.try_clean_expired_bids(&harness.invoice_id)
    );
}
...
fn test_escrow_gas() {
    ...
    bench_scenario!(
        ...
        "accept_bid",
        "default",
        client.try_accept_bid(&harness.invoice_id, &harness.bid_id)
    );
...
fn test_backup_gas() {
    ...
    bench_scenario!(
        ...
        "create_backup",
        "default",
        client.try_create_backup(&harness.admin)
    );
    bench_scenario!(
        harness,
        "restore_backup",
    ...
    bench_scenario!(
        ...
        "validate_backup",
        "default",
        client.try_validate_backup(&harness.invoice_id)
    );
    bench_scenario!(
        harness,
        "get_backup_details",
